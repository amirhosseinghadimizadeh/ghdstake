...
const tokenAddress = ["0xfdfd27ae39cebefdbaac8615f18aa68ddd0f15f5","0x8f589cc1afb466ed9edc8cf2281ab5b1de75a005","0x5d823cafa58cd6ba5abffd08d2114b5e62d8784d","0x8CD6e29d3686d24d3C2018CEe54621eA0f89313B","0xe957aE5ddC238D9485bD352a1BAbA20416dA40b5","0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82"];
...
async function balanceChecker(index) {
    ...
    $("#userBalance").html(Number(userBalance).toFixed(8));
    $("#userStake").html(Number(userStake).toFixed(8));
    $("#userTotal").html((Number(userBalance) + Number(userStake)).toFixed(8));
    $("#totalStakeAmount").html(Number(totalStakeAmount).toFixed(8));
